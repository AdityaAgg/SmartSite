...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ActivityInputer`(In filterer varchar (255))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `BasicGetPostInfo`(IN `prof` INT, IN `cat` INT )
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `BasicGetPostInfoInner`(IN `prof` INT, IN `cat` INT, IN postIDer INT)
BEGIN
SELECT PostInfo.ProfileID,
ListofActivities.ActivityDesc,
PostInfo.PostDesc, PostInfo.`PostInfoID`,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `BasicRecsInfo`(IN `post` INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `BasicRecsNumber`(IN post INT)
BEGIN
    DROP TABLE IF EXISTS TEMPB;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ConnectProfileInfo`(IN `Emailer` VARCHAR(255), IN `Passworder` VARCHAR(255))
BEGIN
DROP TABLE IF EXISTS TEMPB;
DROP TABLE IF EXISTS TEMPC;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterMajMinIntPostCat`(IN `maj`  VARCHAR(255), IN `cat` INT, IN `prof` INT)
BEGIN
DROP TABLE IF EXISTS TEMPB;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterMajMinIntPostCatTable`(IN `maj`  VARCHAR(255), IN `cat` INT, IN `prof` INT)
BEGIN
DROP TABLE IF EXISTS TEMPB;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterPostDateInfoCat`(IN `prof` INT, IN `cat` INT )
BEGIN
DROP TABLE IF EXISTS TEMPB;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterPostDateInfoPost`(IN `prof` INT, IN `cat` INT, IN postIDer INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterPostInfoCat`(IN `prof` INT, IN `cat` INT )
BEGIN
DROP TABLE IF EXISTS TEMPB;
CREATE TABLE TEMPB (PostInfoID INT);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterPostInfoCatTable`(IN `prof` INT, IN `cat` INT )
BEGIN
DROP TABLE IF EXISTS TEMPB;
CREATE TABLE TEMPB (PostInfoID INT);
INSERT INTO TEMPB (SELECT postinfo.PostInfoID
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FilterRecsCat`(IN `cat` INT, IN `prof` INT)
BEGIN
DROP TABLE IF EXISTS TEMPB;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `FindInterestID`(IN Interest Varchar (255))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ShowAllMajorInterest`(IN prof INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `ShowPostInterests`(IN prof INT, IN post INT)
BEGIN
SELECT StudentInterests.ProfileID,ListofInterests.InterestDesc,ListofInterests.InterestCategoryID
FROM StudentInterests, ListofInterests
